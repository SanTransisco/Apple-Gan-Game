...
rand = random.choice(os.listdir(r"Grayscales"))
print(rand)
photo1 = PhotoImage(file="Grayscales/" + rand)
rand = random.choice(os.listdir(r"Grayscales"))
photo2 = PhotoImage(file="Grayscales/" + rand)
Label(window, image=photo1).grid(row=1, column=0, sticky=N)
Label(window, image=photo2).grid(row=1, column=2, sticky=N)
score_string = "Current score: " + str(score) + " / " + str(total) + "\n"
Label(window, text=score_string, font="none 12 bold").grid(row=2, column=0, sticky=W)
